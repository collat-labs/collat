...
const resourceLinks = [
  { label: 'Documentation', href: 'https://docs.mezo.org' },
  { label: 'GitHub', href: 'https://github.com/mezo-org' },
...
const socialLinks = [
  { icon: TwitterXIcon, label: 'Twitter', href: 'https://x.com/MezoNetwork' },
  { icon: DiscordIcon, label: 'Discord', href: 'https://discord.mezo.org' },
  { icon: GithubIcon, label: 'GitHub', href: 'https://github.com/mezo-org' },
]
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-white/30 text-sm leading-relaxed max-w-xs">
              Bitcoin-collateralized spending on Mezo. Deposit BTC, spend MUSD, never sell.
            </p>
          </div>
          ...
          <div className="flex items-center gap-4">
            {socialLinks.map(({ icon: Icon, label, href }) => (
              <a
                ...
                rel="noopener noreferrer"
                aria-label={label}
                className="text-white/30 hover:text-red-500 transition-colors duration-200"
              >
                <Icon size={18} />
              </a>
            ))}
